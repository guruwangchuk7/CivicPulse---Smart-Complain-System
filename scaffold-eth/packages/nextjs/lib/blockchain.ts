...
export const CIVICPULSE_CONTRACT_ADDRESS = "0x5FbDB2315678afecb367f032d93F642f64180aa3";
...
const civicPulseAbi = parseAbi([
  ...
  "function reports(string memory _id) public view returns (string internalId, address reporter, string metadataHash, uint256 timestamp, bool isResolved, string resolutionHash)",
]);
